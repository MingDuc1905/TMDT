...
(22, 'Cánh gà nướng', '2 cánh', 'https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?w=400&h=300&fit=crop', 10, 7, true),
...
(25, 'Ếch nướng', '2 con', 'https://images.unsplash.com/photo-1559847844-5315695dadae?w=400&h=300&fit=crop', 10, 7, true),
...
(39, 'Bún heo quay đặc biệt', '', '', 12, 12, true),
(40, 'Bún mắm nem - chả', '', '', 12, 12, true),
...
(57, 'Bento cake', '', 'https://images.unsplash.com/photo-1558636508-e0db3814bd1d?w=400&h=300&fit=crop', 15, 10, true),
(58, 'Bánh kem decor dễ thương', 'Ngẫu nhiên', 'https://images.unsplash.com/photo-1558636508-e0db3814bd1d?w=400&h=300&fit=crop', 15, 10, true),
(59, 'Bông lan trứng muối size 16', 'Ngẫu nhiên', 'https://images.unsplash.com/photo-1558636508-e0db3814bd1d?w=400&h=300&fit=crop', 15, 10, true),
(60, 'Tiramisu mix bông lan trứng muối - set 9 hộp', '9 hộp', 'https://images.unsplash.com/photo-1558636508-e0db3814bd1d?w=400&h=300&fit=crop', 15, 10, true),
(61, 'Bánh kem trẻ em', 'Ngẫu nhiên', 'https://images.unsplash.com/photo-1558636508-e0db3814bd1d?w=400&h=300&fit=crop', 15, 10, true),
(62, 'Bánh kem trái cây s16', 'Size 16, ngẫu nhiên', 'https://images.unsplash.com/photo-1558636508-e0db3814bd1d?w=400&h=300&fit=crop', 15, 10, true),
(63, 'Set hoa và bánh', 'Hộp gồm bánh và hoa trang trí', 'https://images.unsplash.com/photo-1558636508-e0db3814bd1d?w=400&h=300&fit=crop', 15, 10, true);
