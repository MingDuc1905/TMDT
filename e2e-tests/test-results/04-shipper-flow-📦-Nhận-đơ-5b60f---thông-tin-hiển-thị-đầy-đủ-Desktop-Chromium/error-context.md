...
- Name: 04-shipper-flow.spec.ts >> 📦 Nhận đơn & Quy trình giao hàng >> [TC-4.8] Chi tiết đơn hàng đã nhận - thông tin hiển thị đầy đủ
- Location: tests\04-shipper-flow.spec.ts:148:7
...
Call log:
  - waiting for locator('#orders-paid-tab')
