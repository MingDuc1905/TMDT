...
-- shipperz (userid=4): scannable orders for QR tests
(7, 2, '2026-07-12 10:00:00', 'Chờ shipper lấy hàng', 125000.0000, 1, 'Shipper test - scan QR', NULL, 15000.0000, 5000.0000, '2026-07-12 12:00:00', NULL, 4),
(7, 2, '2026-07-12 10:30:00', 'Đang giao', 85000.0000, 1, 'Shipper test - mid delivery', NULL, 15000.0000, 5000.0000, '2026-07-12 12:30:00', NULL, 4),
-- customer test orders (levanc userid=2): checkout & history filter tests
(8, 2, '2026-07-12 11:00:00', 'Đã đặt', 110000.0000, 2, 'Checkout flow test', NULL, 15000.0000, 5000.0000, '2026-07-12 13:00:00', NULL, 3),
(8, 2, '2026-07-12 11:30:00', 'Đang giao', 95000.0000, 2, 'Order history filter test', NULL, 15000.0000, 5000.0000, '2026-07-12 13:30:00', NULL, 3);
...
(1, 2, 1, 80000.0000),
(2, 2, 1, 80000.0000),
-- Order 3: shipperz, Chờ shipper lấy hàng
(3, 3, 1, 70000.0000),
(3, 10, 2, 10000.0000),
-- Order 4: shipperz, Đang giao
(4, 11, 1, 40000.0000),
(4, 12, 1, 50000.0000),
-- Order 5: customer, Đã đặt
(5, 21, 1, 39000.0000),
(5, 22, 1, 38000.0000),
(5, 10, 1, 10000.0000),
-- Order 6: customer, Đang giao
(6, 46, 1, 275000.0000);
...
(3, 'Đơn hàng đã được tiếp nhận, shipper đang đến lấy', 4, 2),
(4, 'Đơn hàng đang được giao đến bạn', 4, 2),
(5, 'Đơn hàng của bạn đã được xác nhận', 3, 2),
(6, 'Đơn hàng của bạn đang được vận chuyển', 3, 2);
