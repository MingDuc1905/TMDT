...
- Name: 02-customer-flow.spec.ts >> 💳 Thanh toán - Complete Order Flow >> [TC-2.19] Checkout - form validation: không điền địa chỉ, bấm submit
- Location: tests\02-customer-flow.spec.ts:478:7
